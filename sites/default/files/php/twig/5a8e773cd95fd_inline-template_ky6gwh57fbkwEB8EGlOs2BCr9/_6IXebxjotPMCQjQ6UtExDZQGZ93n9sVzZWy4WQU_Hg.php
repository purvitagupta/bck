...
/* {# inline_template_start #}<div class="start-year">{{ field_start_year }}{{ field_end_year }} </div>
<div class="quote">{{ body }}</div> */
class __TwigTemplate_f148f035abe093321507842b6744e20f447f77382b772bb311417623ef4fea0b extends Twig_Template
{
...
<div class=\"quote\">";
    ...
    {
        return "{# inline_template_start #}<div class=\"start-year\">{{ field_start_year }}{{ field_end_year }} </div>
<div class=\"quote\">{{ body }}</div>";
    }
    ...
    {
        return new Twig_Source("", "{# inline_template_start #}<div class=\"start-year\">{{ field_start_year }}{{ field_end_year }} </div>
<div class=\"quote\">{{ body }}</div>", "");
    }
}
