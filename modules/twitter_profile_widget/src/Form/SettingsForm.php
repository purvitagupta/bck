...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['integrate_blocks'] = [
      ...
      '#default_value' => $config->get('integrate_blocks'),
    ];
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($connection !== TRUE) {
      $form_state->setErrorByName('twitter_widget_secret', $result->errors[0]->message . $this->t('The form has not been updated; any previously valid data you entered will remain active.'));
    }
  }
